...
class Page
{
	public static function header($title)
	{
		...
		if(isset($_SESSION['nombre_usuario']))
		{
			print("
					...
					<nav class='azul'>
						<div class='nav-wrapper'>
							...
							<ul class='right hide-on-med-and-down'>
						    	<li><a href='../clients/'><i class='material-icons left'>shop</i>Clientes</a></li>
								<li><a href='../oferts/'><i class='material-icons left'>shop</i>ofertas</a></li>
                ...
                <a href='#'  data-activates='slide-out2' class='button-collapse sidenavaa'><img class='circle' src='../../img/next.png'></a>
			...
			{
			Page::showMessage(3, "ya ha iniciado sesion", 'index.php');
			}
		}
		else
		{
			print("
				<header class='navbar-fixed'>
			        ...
			        <br>
				<main class='row containerfull borderazul'>
				<div class='col s12 m6 '>
		...
		print("
			...
			<footer class='page-footer azul'>
				...
				<div class='footer-copyright'>
					<div class='container'>
						<span>©".date('Y ')."CardTrader, todos los derechos reservados.</span>
					</div>
				</div>
			</footer>
	...
	public static function setCombo($label, $name, $value, $query)
	{
		...
		print("<select name='$name' id ='$name' required>");
		if($data != null)
		{
			if($value == null)
			{
